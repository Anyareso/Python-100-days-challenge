...
# For the second print statement, it gets executed after the first print statement
# Then adds 'Pie' to the fruit for each fruit
# The last line of code is outside the loop
# This means that it won't iterate through each item on the list
#  but rather displays the list as a whole
